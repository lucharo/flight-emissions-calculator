...
{#if showResults}
<div class="w-[400px] bg-white/90 backdrop-blur-sm rounded-lg border border-border p-4 shadow-lg">
  ...
  <div class="space-y-4">
      ...
      <div class="grid gap-2">
        <div class="flex items-center gap-2 text-sm">
          ...
          <div class="group relative">
            ...
            <div class="invisible group-hover:visible absolute bottom-full right-0 mb-2 w-64 p-2 bg-gray-900 text-white text-xs rounded shadow-lg z-50">
              {equivalencies.burger.tooltip}
              <div class="absolute bottom-[-6px] right-[10px] w-3 h-3 bg-gray-900 transform rotate-45"></div>
            </div>
          </div>
        </div>
        ...
        <div class="flex items-center gap-2 text-sm">
          <span class="text-xl">🏠</span>
          <span>{kgCO2ToHouseholdDays(result.emissions)} days of average household emissions</span>
          <div class="group relative">
            <button
              type="button"
              class="w-4 h-4 text-gray-400 hover:text-gray-600 focus:outline-none"
    ...
    <div class="space-y-2 text-xs text-muted-foreground mt-4">
      <p>
        Aviation accounts for approximately 2.5% of global CO₂ emissions
        (<a 
      ...
      <p>
        The average person's annual carbon budget for 1.5°C warming is 2.3 tonnes of CO₂
        <a 
